...
Route::get('/system', 'App\Http\Controllers\MainController@about')->name('about');
...
Route::post('/admin/paiedgo', 'App\Http\Controllers\AdminController@adminPayedGo')->name('adminPayedGo')->middleware('auth', 'is_admin');
...
Route::post('/payeer', 'App\Http\Controllers\PayeerController@payeer')->name('payeer');
