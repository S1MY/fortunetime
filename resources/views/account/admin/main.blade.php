...
@section('content')
    ...
    <div class="popupResponse changeRef">
        ...
        <div class="popupResponseItem">
            ...
            <form action="{{ route('changeUserReferal') }}" id="changeReferal" method="POST">
                <input type="hidden" name="changeID" id="changeID" value="">
                <input type="text" class="formInput" style="width: 100%" name="newSponsor" placeholder="Введите логин нового реферала">
