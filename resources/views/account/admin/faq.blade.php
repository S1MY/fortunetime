            ...
            <div class="pageInner adminFaq">
                ...
                <div class="answerItem">
                    <p class="answerHeader displayFlex alignItemsCenter">
                        ...
                        <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24" class="answerIcon editIcon" title="Изменить" data-faq-id="{{ $faq->id }}">
                    ...
                    <div class="answerContent">{!! $faq->answer !!}</div>
                </div>
                @endforeach
