    ...
    <section class="pageSection">
        <div class="container">
            <div class="pageInner">
                ...
                <p class="cabinetText">Старт маркетинг проекта будет 23.11.2022!</p>
                <p class="cabinetText">В данный наблюдаем за нагрузкой оказанной на сервер и на сайт!</p>
                <p class="cabinetText">Мы обязательно оповестим вас по EMail адрессу и в наших группах!</p>
            </div>
        </div>
    </section>
@endsection
